...
| 排名 | 当前得分 | GitHub项目 | 
| - | -------- | -------- | 
| 1 | 870 | [【AI创造营】是极客就坚持100秒 - 超火的AI小游戏](https://github.com/ninetailskim/DodgeFace) |
| 2 | 790 | [Wechaty社区大使带你玩转专属微信Bot](https://github.com/dephrast/botbay) |
| 3 | 530 | [基于DeepSpeech实现的语音识别框架](https://github.com/yeyupiaoling/PaddlePaddle-DeepSpeech) |
| 4 | 450 | [PaTTA：可用于比赛快速提分的TTA模型强化工具](https://github.com/AgentMaker/PaTTA) |
| 5 | 400 | [RLBooks：基于飞桨2.0的强化学习完整教程](https://github.com/AgentMaker/Paddle-RLBooks) |
| 6 | 370 | [PPIM：飞桨前沿CV算法复现库](https://github.com/AgentMaker/Paddle-Image-Models) |
...
| 9 | 190 | [基于飞桨2.0的3D点云处理库，可实现3D分类、分割、目标检测](https://github.com/AgentMaker/PAPC) |
| 10 | 170 | [可通过文字来生成图像的DALL-E模型复现](https://github.com/AgentMaker/Paddle-DALL-E) |
| 11 | 170 | [微信可用的熊猫头表情生成器机器人完整代码](https://github.com/ninetailskim/PandaFaceGenerator) |
| 12 | 150 | [Zero-Shot的CLIP模型，无需训练也能有不错效果的分类模型](https://github.com/AgentMaker/Paddle-CLIP) |
| 13 | 110 | [可通过文字来在线下载图像的IMSP模型复现](https://github.com/AgentMaker/Paddle-IMSP) |
| 14 | 100 | [飞桨2.0高阶算子合集库](https://github.com/AgentMaker/Paddle-Custom-Operators) |
...
| 19 | 60 | [多轮对话场景的对话的微信聊天机器人，甚至可以对对联](https://github.com/kevinfu1717/multimediaChatbot) |
| 20 | 50 | [[AI创造营]基于PaddleHub的智能工具箱AI Tools](https://github.com/leigangblog/AI_Tools) |
| 21 | 50 | [可快速入门的端到端语音识别框架](https://github.com/yeyupiaoling/PPASR) |
| 22 | 50 | [移动端人脸识别方案](https://github.com/yeyupiaoling/PaddlePaddle-MobileFaceNets) |
| 23 | 50 | [李宏毅老师系列课程三岁白话系列](https://github.com/jhcgt4869/LiHongyi_curriculum_experience) |
| 24 | 50 | [螺旋桨RNA结构预测竞赛解决方案](https://github.com/jhcgt4869/Unpaired_Probability_Prediction_The_first_ten) |
| 25 | 40 | [基于Paddlehub与Wechaty的微信小助手--懂懂](https://github.com/leigangblog/Paddlehub_wechaty) |
| 26 | 40 | [基于VGG的MaskDetection](https://github.com/yangzepeng0516/mask_classification) |
| 27 | 40 | [可实现人脸识别的MTCNN多任务实战方案](https://github.com/yeyupiaoling/PaddlePaddle-MTCNN) |
| 28 | 40 | [声纹识别实战教程](https://github.com/yeyupiaoling/VoiceprintRecognition-PaddlePaddle) |
| 29 | 30 | [可支持NES游戏的强化学习教程](https://github.com/yeyupiaoling/ReinforcementLearning) |
...
| - | -------- | -------- | 
| 1 | 1940.0 | AgentMaker |
| 2 | 1110.0 | yeyupiaoling |
| 3 | 1050.4 | ninetailskim |
| 4 | 797.9 | dephrast |
| 5 | 287.8 | thomas-yanxin |
| 6 | 244.4 | Attackzzw |
| 7 | 127.8 | jhcgt4869 |
| 8 | 90.9 | leigangblog |
| 9 | 60.6 | kevinfu1717 |
| 10 | 42.7 | GT-ZhangAcer |
