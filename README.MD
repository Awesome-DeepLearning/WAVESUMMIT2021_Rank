...
| 排名 | 当前得分 | GitHub项目 | 
| - | -------- | -------- | 
| 1 | 1120 | [Wechaty社区大使带你玩转专属微信Bot](https://github.com/dephrast/botbay) |
...
| 4 | 490 | [PaTTA：可用于比赛快速提分的TTA模型强化工具](https://github.com/AgentMaker/PaTTA) |
| 5 | 470 | [RLBooks：基于飞桨2.0的强化学习完整教程](https://github.com/AgentMaker/Paddle-RLBooks) |
| 6 | 440 | [PPIM：飞桨前沿CV算法复现库](https://github.com/AgentMaker/Paddle-Image-Models) |
| 7 | 242 | [-AI-emmmm](https://github.com/Attackzzw/-AI-emmmm) |
| 8 | 240 | [全流程可落地的垃圾分类完整方案](https://github.com/thomas-yanxin/the-eye-knows-the-garbage) |
| 9 | 230 | [基于飞桨2.0的3D点云处理库，可实现3D分类、分割、目标检测](https://github.com/AgentMaker/PAPC) |
| 10 | 210 | [可通过文字来生成图像的DALL-E模型复现](https://github.com/AgentMaker/Paddle-DALL-E) |
| 11 | 190 | [Zero-Shot的CLIP模型，无需训练也能有不错效果的分类模型](https://github.com/AgentMaker/Paddle-CLIP) |
| 12 | 170 | [微信可用的熊猫头表情生成器机器人完整代码](https://github.com/ninetailskim/PandaFaceGenerator) |
...
| 15 | 90 | [飞桨Fluid版本的SSD实现教程](https://github.com/yeyupiaoling/PaddlePaddle-SSD) |
| 16 | 90 | [飞桨2.0OCR识别案例](https://github.com/yeyupiaoling/PaddlePaddle-CRNN) |
| 17 | 80 | [人流密度检测方案](https://github.com/yeyupiaoling/PaddlePaddle-CrowdNet) |
| 18 | 80 | [飞桨静态图版本的PPYOLO实现完整代码](https://github.com/yeyupiaoling/PP-YOLO) |
| 19 | 70 | [多轮对话场景的对话的微信聊天机器人，甚至可以对对联](https://github.com/kevinfu1717/multimediaChatbot) |
| 20 | 60 | [可快速入门的端到端语音识别框架](https://github.com/yeyupiaoling/PPASR) |
| 21 | 50 | [[AI创造营]基于PaddleHub的智能工具箱AI Tools](https://github.com/leigangblog/AI_Tools) |
| 22 | 50 | [可实现人脸识别的MTCNN多任务实战方案](https://github.com/yeyupiaoling/PaddlePaddle-MTCNN) |
| 23 | 50 | [移动端人脸识别方案](https://github.com/yeyupiaoling/PaddlePaddle-MobileFaceNets) |
| 24 | 50 | [李宏毅老师系列课程三岁白话系列](https://github.com/jhcgt4869/LiHongyi_curriculum_experience) |
| 25 | 50 | [螺旋桨RNA结构预测竞赛解决方案](https://github.com/jhcgt4869/Unpaired_Probability_Prediction_The_first_ten) |
| 26 | 40 | [基于Paddlehub与Wechaty的微信小助手--懂懂](https://github.com/leigangblog/Paddlehub_wechaty) |
| 27 | 40 | [基于VGG的MaskDetection](https://github.com/yangzepeng0516/mask_classification) |
| 28 | 40 | [可支持NES游戏的强化学习教程](https://github.com/yeyupiaoling/ReinforcementLearning) |
| 29 | 40 | [声纹识别实战教程](https://github.com/yeyupiaoling/VoiceprintRecognition-PaddlePaddle) |
| 30 | 30 | [音频分类全流程实战](https://github.com/yeyupiaoling/AudioClassification-PaddlePaddle) |
| 31 | 20 | [AI量子电路合成源代码](https://github.com/yangguohao/quantum) |
...
| - | -------- | -------- | 
| 1 | 2300.0 | AgentMaker |
| 2 | 1160.0 | yeyupiaoling |
| 3 | 1131.2 | dephrast |
| 4 | 1060.5 | ninetailskim |
| 5 | 297.5 | thomas-yanxin |
| 6 | 244.4 | Attackzzw |
| 7 | 139.0 | jhcgt4869 |
| 8 | 90.9 | leigangblog |
| 9 | 70.7 | kevinfu1717 |
| 10 | 49.6 | GT-ZhangAcer |
| 11 | 40.4 | yangzepeng0516 |
| 12 | 31.5 | qeebeast7 |
| 13 | 20.0 | yangguohao |
