...
| 排名 | 当前得分 | GitHub项目 | 
| - | -------- | -------- | 
| 0 | 830 | [【AI创造营】是极客就坚持100秒 - 超火的AI小游戏](ninetailskim/DodgeFace) |
| 1 | 350 | [PaTTA：可用于比赛快速提分的TTA模型强化工具](AgentMaker/PaTTA) |
| 2 | 270 | [RLBooks：基于飞桨2.0的强化学习完整教程](AgentMaker/Paddle-RLBooks) |
| 3 | 260 | [PPIM：飞桨前沿CV算法复现库](AgentMaker/Paddle-Image-Models) |
| 4 | 180 | [全流程可落地的垃圾分类完整方案](thomas-yanxin/the-eye-knows-the-garbage) |
| 5 | 140 | [基于飞桨2.0的3D点云处理库，可实现3D分类、分割、目标检测](AgentMaker/PAPC) |
| 6 | 140 | [可通过文字来生成图像的DALL-E模型复现](AgentMaker/Paddle-DALL-E) |
| 7 | 120 | [Zero-Shot的CLIP模型，无需训练也能有不错效果的分类模型](AgentMaker/Paddle-CLIP) |
| 8 | 100 | [微信可用的熊猫头表情生成器机器人完整代码](ninetailskim/PandaFaceGenerator) |
| 9 | 80 | [可通过文字来在线下载图像的IMSP模型复现](AgentMaker/Paddle-IMSP) |
| 10 | 70 | [飞桨2.0高阶算子合集库](AgentMaker/Paddle-Custom-Operators) |
| 11 | 50 | [多轮对话场景的对话的微信聊天机器人，甚至可以对对联](kevinfu1717/multimediaChatbot) |
| 12 | 20 | [AI量子电路合成源代码](yangguohao/quantum) |
...
| - | -------- | -------- | 
| 0 | 1430.0 | AgentMaker |
| 1 | 939.3 | ninetailskim |
| 2 | 197.3 | thomas-yanxin |
| 3 | 50.5 | kevinfu1717 |
| 4 | 24.5 | GT-ZhangAcer |
| 5 | 20.0 | yangguohao |
